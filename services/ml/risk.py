...
# Check multiple locations for the pre-trained model
_candidates = [
    BASE_DIR / "models" / "xgb_risk_model.pkl",                        # local to service
    BASE_DIR.parent.parent / "models" / "xgb_risk_model.pkl",  # shared repo-root models/
]
